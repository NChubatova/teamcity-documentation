...
* OpenSSH format SSH keys generated by Devolutions Remote Desktop Manager cannot be used within TeamCity. As a workaround, these keys could be fixed by importing in `puttygen` and export back in OpenSSH format. See this YouTrack ticket for more information: [TW-91528](https://youtrack.jetbrains.com/issue/TW-91528/OpenSSH-SSH-keys-generated-by-Devolutions-Remote-Desktop-Manager-stop-working-after-upgrade-to-2024.12#focus=Comments-27-11367828.0-0)
* Using Git via SSH may be unavailable for some versions of RHEL. See this YouTrack ticket for more information: [TW-91621](https://youtrack.jetbrains.com/issue/TW-91621)
