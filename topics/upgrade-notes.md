...
* Using Git SSH proxy settings (`teamcity.git.sshProxy*`) may require additional installation of `netcat` utility for servers running on some Linux distributions including RHEL. See this YouTrack ticket for more information: [TW-91621](https://youtrack.jetbrains.com/issue/TW-91621).
